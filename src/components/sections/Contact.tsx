      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          >
            ...
            {/* Company Field */}
            <div className={`${styles.formGroup} ${isFieldActive('company') ? styles.active : ''}`}>
            ...
            {/* Message Field */}
            <div className={`${styles.formGroup} ${styles.formGroupMessage} ${isFieldActive('message') ? styles.active : ''}`}>
          ...
          >
            <div className={styles.infoItem}>
              ...
              <a href="mailto:hello@stackrover.com" className={styles.infoValue} data-cursor="hover">
                hello@stackrover.com
              </a>
            </div>

            <div className={styles.infoItem}>
              <span className={styles.infoLabel}>Phone</span>
              <a href="tel:+1234567890" className={styles.infoValue} data-cursor="hover">
                +1 (234) 567-890
              </a>
            </div>
            ...
            <div className={styles.infoItem}>
              ...
              <div className={styles.socialLinks}>
                ...
                <a href="#" className={styles.socialLink} data-cursor="hover">Instagram</a>
                <a href="#" className={styles.socialLink} data-cursor="hover">Dribbble</a>
              </div>
            </div>
          </motion.div>
        </div>
